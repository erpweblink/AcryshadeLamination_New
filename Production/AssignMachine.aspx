...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function validateTime() {
            var from = document.getElementById('<%= txtFromTime.ClientID %>').value;
            var to = document.getElementById('<%= txtToTime.ClientID %>').value;
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <asp:TextBox ID="txtToTime" CssClass="form-control" runat="server" TextMode="Time" ValidationGroup="001"  onchange="validateTime()"></asp:TextBox>
                            ...
                            <asp:CustomValidator ID="cvTime" runat="server" ControlToValidate="txtToTime" ValidationGroup="001"
                                ForeColor="Red" ErrorMessage="To Time must be greater than From Time." OnServerValidate="cvTime_ServerValidate"></asp:CustomValidator>
                        </div>
                    </div>
                    <hr />
                    <center>
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="GVCompany" runat="server" DataKeyNames="ID" OnRowDataBound="GVCompany_RowDataBound" CssClass="table table-bordered table-striped" HeaderStyle-BackColor="#2d6be0"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="From Date" HeaderStyle-ForeColor="White"  ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblFromDate" runat="server" Text='<%#Eval("FromDate")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="To Date" HeaderStyle-ForeColor="White"  ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblToDate" runat="server" Text='<%#Eval("ToDate")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="From Time" HeaderStyle-ForeColor="White"  ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblFromTime" runat="server" Text='<%#Eval("FromTime")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="To Time" HeaderStyle-ForeColor="White"  ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
